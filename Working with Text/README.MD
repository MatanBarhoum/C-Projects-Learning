# Working with text, String Builder and methods.

I learnt alot about Linq and how to use it within a code. Also I was first introduce to System.Globalization Assembly which help a lot with TextInfo and CultureInfo. 
Learnt about DateTime and the TryParse to convert a string of HH:mm to a DateTime and check (bool) if true and is correct. (Exercise 3)
